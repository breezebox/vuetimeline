'use strict';Object.defineProperty(exports,'__esModule',{value:true});function _interopDefault(e){return(e&&(typeof e==='object')&&'default'in e)?e['default']:e}var vuedarkmode=require('@growthbunker/vuedarkmode'),timeago_js=require('timeago.js');require('dayjs/locale/ja');var dayjs=_interopDefault(require('dayjs'));/**************************************************************************
 * MIXINS > THEME
...
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',{class:[
  ...
  ]},[_vm._ssrNode("<div class=\"gb-vue-timeline-update__left\"><span class=\"gb-vue-timeline-update__ago\">"+_vm._ssrEscape(_vm._s(_vm.yyyy))+"</span></div>"),_vm._ssrNode("<div class=\"gb-vue-timeline-update__center\">","</div>",[_c('base-number',{staticClass:"gb-vue-timeline-update__bullet",attrs:{"color":_vm.color,"icon":_vm.icon,"theme":_vm.computedTheme,"icon-size":"16px","size":"small"}}),_vm._ssrNode("<span class=\"gb-vue-timeline-update__line\"></span>")],2),_vm._ssrNode("<div"+(_vm._ssrClass(null,[
      "gb-vue-timeline-update__right",
      {
        "gb-vue-timeline-update__right--clickable": _vm.$listeners.click
      }
    ]))+">","</div>",[_vm._ssrNode("<div class=\"gb-vue-timeline-update__information\">","</div>",[_vm._ssrNode("<div class=\"gb-vue-timeline-update__meta\">","</div>",[(_vm.category)?_c('base-badge',{staticClass:"gb-vue-timeline-update__category",attrs:{"color":_vm.color,"filled":true,"theme":_vm.computedTheme,"size":"small"}},[_vm._v(_vm._s(_vm.category))]):_vm._e(),_vm._ssrNode("<span class=\"gb-vue-timeline-update__ago\">"+_vm._ssrEscape(_vm._s(_vm.yyyy))+"</span>")],2),_vm._ssrNode("<h2"+(_vm._ssrClass(null,[
